...
const MFAppColorPrimary = Color(0xFF2F65B9);

//Section BG / page BG
const MFAppLayoutBackground = Color(0xFFF4F7F6);
const MFAppSectionBackground = Color(0xFFFFFFFF);
const MFAppBorderColor = Color(0xFFD9DFEB);
// Tertiary

const MFBodyWhite = Color(0xFF6F7F92);
const MFBodyDark = Color(0xFFF5F5F5);
const MFDividerColor = Color(0xFFE1E5EF);
